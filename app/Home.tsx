            ...
            >
              {filteredProperties.length > 0 ? (
                filteredProperties.slice(0, 9).map(prop => (
                  <View key={prop.id} style={{ width: width - 40, marginRight: 10 }}>
                    <PropertyCard property={prop} />
                  </View>
                ))
              ) : (
                <View style={{ padding: 40, alignItems: 'center', width: width - 40 }}>
...
const styles = StyleSheet.create({
  ...
  modalOverlay: {
    flex: 1,
    backgroundColor: 'rgba(28, 25, 23, 0.6)', // matching secondary/charcoal color with transparency
  ...
  adOverlay: {
    flex: 1,
    backgroundColor: 'rgba(28, 25, 23, 0.7)', // Deep stone/charcoal background on ad overlay
    borderRadius: 20,
    padding: 35,
    justifyContent: 'center',
    alignItems: 'flex-start',
